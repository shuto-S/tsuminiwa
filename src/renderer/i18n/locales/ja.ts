...
export const ja = {
  ...
  'ui.hintView': 'ブロックをえらぶと編集できます ／ ホイール: ズーム',
  'ui.hintPlace': '{name}を置く ／ 右クリック: こわす ／ ホイール: ズーム',
  'ui.hintErase': '左クリック: こわす ／ ホイール: ズーム',
  'ui.welcome': '🌱 下のパレットからブロックをえらぶと、世界を編集できます',
  ...
  'settings.aiNote':
    'AIはオプトインです。オフ・未設定・オフライン時は従来どおり動きます。キーは端末内で暗号化保存されます。',
  'ai.testOk': '✅ 接続できた',
  ...
  'ai.needEnabled': '⚠️ 先にAIフレーバー生成をオンにしてください',
  ...
  'settings.aiWorldgenPlaceholder': '例: 湖のまわりに森がある島',
  ...
  'settings.resetNote': 'マス数・高さ上限を変えると、操作を終えた時に世界がつくりなおされます',
  'world.regenerated': '🌏 世界をつくりなおしました',
  'world.undo': '元にもどす',
  'world.restored': '↩️ もとの世界にもどしました',
  'save.recovered': '🛟 バックアップから世界を復元しました',
  'save.failed': '⚠️ セーブを読み込めなかったため、新しい世界をつくりました',
  'save.writeFailed': '⚠️ 世界を保存できませんでした',
  'log.header': '村のきろく',
  'log.clear': 'きろくを消す',
  'log.empty': 'まだ きろくはありません',

  // ---- スクショのプレビュー ----
  'shot.save': '💾 保存',
  'shot.header': 'スクリーンショット',
  'shot.share': '𝕏 シェア',
  'shot.close': 'とじる',
  'shot.saved': '📷 保存した',
