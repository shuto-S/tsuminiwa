...
export const en = {
  ...
  'ui.hintView': 'Choose a block to edit / Wheel: zoom',
  'ui.hintPlace': 'Place {name} / Right click: remove / Wheel: zoom',
  'ui.hintErase': 'Left click: remove / Wheel: zoom',
  'ui.welcome': '🌱 Choose a block from the palette below to edit your world',
  ...
  'ai.needEnabled': '⚠️ Turn on AI flavor generation first',
  ...
  'settings.aiWorldgenPlaceholder': 'e.g. An island with a forest around a lake',
  ...
  'settings.resetNote':
    'Changing grid size or max height rebuilds the world when you finish the adjustment',
  'world.regenerated': '🌏 World rebuilt',
  'world.undo': 'Undo',
  'world.restored': '↩️ Restored the previous world',
  'save.recovered': '🛟 Restored your world from a backup',
  'save.failed': '⚠️ The save could not be loaded, so a new world was created',
  'save.writeFailed': '⚠️ The world could not be saved',
  'log.header': 'Village log',
  'log.clear': 'Clear log',
  'log.empty': 'Nothing has been recorded yet',
